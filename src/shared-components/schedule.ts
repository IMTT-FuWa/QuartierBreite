/**
* This is a customization of Primeng's Schedule Component
* since we only add functioniality we keep their selector,
* so implementations of modules can switch back to the original
* version of Primeng if necessary (e.g. after updates of the library)
**/
...
export class Schedule implements AfterViewInit, DoCheck, OnDestroy {
  ...
  ngAfterViewInit() {
    ...
    let options = {
      ...
      events: (_start, _end, _timezone, callback) => {
      ...
      eventDragStart: (event, jsEvent, _ui, view) => {
      ...
      eventDragStop: (event, jsEvent, _ui, view) => {
      ...
      eventDrop: (event, delta, revertFunc, jsEvent, _ui, view) => {
      ...
      eventResizeStart: (event, jsEvent, _ui, view) => {
      ...
      eventResizeStop: (event, jsEvent, _ui, view) => {
      ...
      eventResize: (event, delta, revertFunc, jsEvent, _ui, view) => {
