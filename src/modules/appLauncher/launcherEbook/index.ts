...
@Injectable()
export class LauncherEbook extends ExternalModuleBase {

    /**
    * this should be configured to meet the apps expected identifiers
    **/
    schemes: IAppLauncherScheme = {
        appName: "Bluefire Reader",
        iosScheme: {
            scheme: "bluefirereader://",
            storeUrl: "https://itunes.apple.com/de/app/bluefire-reader/id394275498?mt=8",
        },
        androidScheme: {
            scheme: "com.bluefirereader",
            storeUrl: "https://play.google.com/store/apps/details?id=com.bluefirereader&hl=de",
        },
        wpScheme: "bluefirereader:"
    }
    ...
    runExternal() {
        ...
        _paq.push(['trackEvent', 'Menu-Navigation', 'Bluefire Reader gestartet']);
    }
}
